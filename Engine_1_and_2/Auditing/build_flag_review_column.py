...
FLAG_DISPOSITIONS = [
    ...
    ("contains", "country/nationality recognized via a supplementary list", "Country via supplementary list",
     "DROP", "detection-provenance note; does not drive a review action"),
    ...
    ("contains", "religious organization name only", "Religious org name only",
     "KEEP", "prevents religion->ethnicity error; actionable"),
    ...
    ("contains", "two-spirit present", "Two-Spirit also an Indigenous signal",
     "KEEP", "actionable cross-axis link"),
