...
FLAG_SHORT = [
    ("directional region", "Directional region pattern (e.g. North/East African)"),
    ...
    ("emphasis phrase", "Emphasis phrase ('especially'/'particularly')"),
    ("bipoc", "BIPOC signal"),
    ...
    ("country/nationality mapping", "Country / nationality mapping"),
